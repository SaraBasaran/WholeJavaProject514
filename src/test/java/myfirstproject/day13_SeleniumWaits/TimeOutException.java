...
//        When you use implicitly wait, and element is not found within given time, then still throws NoSuchElementException
    }
...
//        my locator is correct but the explicit wait time is not enough, then throws TimeoutException
